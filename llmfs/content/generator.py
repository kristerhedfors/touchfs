...
def generate_filesystem(prompt: str) -> dict:
    ...
    The filesystem must follow this exact structure:
    {
      "data": {
        ...
        "/README.llmfs": {
          ...
          "xattrs": {
            "generator": "readme"  # Also mark for readme plugin generation
          }
        }
      }
    }
    ...
    9. Always include a README.md (and optionally README.llmfs) with xattrs.generator = "readme"
    """
    ...
    try:
        ...
        # Ensure all Python files are marked for default generation
